...
function DeleteUnit(id){
    var r=confirm("Are you sure you want to remove order unit "+id+"?");
		...
		freq();
        if(req){
            req.onreadystatechange = delete_unit;
            url = 'contest_response.php?type=9&id='+id;
...
<tr class="cell_reccolor_lightblue_01a">
    <td>ID:</td><td>{$uid} {if $wo_unit_print}&nbsp;<a href="#" onClick="window.open('print_wounit.php?oid={$oid}&uid={$uid}&pict='+picture

+'&disc='+disclaimer,'print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');"><img src="gfx/printer.gif" border="0" alt="Print unit price.{if $can_always_print && !

$can_print}Warning: no deposit on that order or invoice no. was not generated!{/if}"></a>
        ...
        <a href= "#"  onclick="window.open('acc_inf.php?oid={$oid}','acc_info','toolbar=0,menu=0,left=100,top=30,scrollbars=0,resizable=0, status=0,width=500,height=420' 
            ...
            <img src="gfx/show1.gif" onmouseover="this.src='gfx/show0.gif'" onmouseout="this.src='gfx/show1.gif'"style="cursor:hand" border="0" alt="Account information" 
...
<tr class="cell_reccolor_lightblue_01b">
    <td>Name:*</td>
    <td><input type="text" style="border:1px solid #000000"  name="edit[name]" size="20" maxlength="50"{$lock_form}></td>
</tr>
<tr class="cell_reccolor_lightblue_01a">
    <td>Application:*</td>
    <td>
...
<tr class="cell_reccolor_lightblue_01b"  {if $uid eq ''}style="display:none;"{/if}>
    ...
    <td><input type="text" {if $ord_unit.cust_price eq true}value="{$ord_unit.cust_price}"{else}value="0"{/if} name="edit[cust_price]" size="10" maxlength="50" id="paid" 

onKeyPress="return decimalWrite(event,'paid',2)"{$lock_form}>&nbsp;<b>$</b></td>
</tr>
<tr class="cell_reccolor_lightblue_01a"  {if $uid eq ''}style="display:none;"{/if}>
...
<tr><td colspan="2"><table width="100%" cellspacing="0" cellpadding="2" style="border: 1px solid black;">
            <tr class="cell_reccolor_blue_01b">
                <td>Stone search:</td>
                <td><input type="text" name="edit[string]" value="{$ord_unit.string}"{$lock_form}>&nbsp;<input type="button" class="BUTTON_OK" value="Search" 

onClick="sub(1);"{$lock_select}></td>
            </tr>
                ...
                {if $f_cnt>0}
                    <td colspan="2" align="center">
                        <select name="edit[id_slab_frame]" id="id_slab_frame" style="width: 350px"{$lock_select}>
                            ...
                            {if $ord_unit.id_slab_frame eq $slabs[xx].sf_id && $slabs[xx].sl_outside == 0}<script>document.getElementById('outside').innerHTML = 'Do not 

use this stone outside.';</script>{/if}
                            {if $ord_unit.id_slab_frame eq $slabs[xx].sf_id && $slabs[xx].sl_risky == 1}<script>document.getElementById('risky').innerHTML = 'Stone may 

stain or damage during production.';</script>{/if}
                            <option value="{$slabs[xx].sf_id}" {if $ord_unit.id_slab_frame eq $slabs[xx].sf_id}selected{/if}>{$slabs[xx].st_name}-{$slabs[xx].st_id}-

{$slabs[xx].f_sign}-{$slabs[xx].sl_thick}-{$slabs[xx].sl_widht}x{$slabs[xx].sl_length}-{if ($slabs[xx].sc_name)==null}Super Premium {else}{$slabs[xx].sc_name}{/if}
                                {/section}
                        </select>
                    </td>
                {else}
...
{if $uid==''}
    ...
    {section name=unt1 loop=$crunits1}
    ...
    {section name=e loop=$e_forms}
        <tr class="cell_reccolor_blue_01a">
            <td width="200">
                ...
                {if $e_forms[e].signed != 1}<a href="#" onClick="javascript:window.open('e_forms.php?oid={$oid}&fid={$e_forms

[e].id}','print_eform','height=740,width=1024,left='+szer+',top=0,toolbar=0,menu=0,scrollbars=0,resizable=0');">{$e_forms[e].name}</a>{else}
                    <a href="#" onClick="javascript:window.open('e_forms.php?oid={$oid}&fid={$e_forms

[e].id}','print_eform','height=880,width=750,toolbar=1,menu=1,scrollbars=1,resizable=0');">{$e_forms[e].name}</a>{/if}
            </td>
            <td width="85">
...
<tr class="cell_reccolor_neutral_01">
    <td width="100%">
        <iframe height="150" width="350" name="spis" frameborder="0" {if $ord_unit.id_application}src="app_question.php?id={$ord_unit.id_application}"{else}

src="app_question.php"{/if}>twoja przegladarka nie obsluguje ramek</iframe>
    </td>
</tr>
{include file="search_footer.tpl"}
  ...
  {include file="table_header.tpl"}
         ...
         {assign var="_i_" value=$smarty.section.unt.index}
          <tr class="{if $_i_ is even}cell_reccolor_green_01a{else}cell_reccolor_green_01b{/if}">
           ...
           <td ><a href="element_rectedit.php?id={$crrectangles[unt].id}&uid={$uid}&oid={$oid}&ida={$id_account}"><img src="gfx/edit_one1.gif" 

onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit rectangle '{$crrectangles[unt].id}'" border="0"></a>
             {if $delete eq true && $unit_edit}<a href="ord_unitedit.php?delete=1&id={$crrectangles[unt].id}&uid={$uid}&oid={$oid}&ida={$id_account}" onclick="return 

askme('Rectangle \'{$data[dat].id}\'')"><img src="gfx/trash1.gif" onmouseover="this.src='gfx/trash0.gif'" onmouseout="this.src='gfx/trash1.gif'" alt="Remove '{$data

[dat].id}'" border="0"></a>&nbsp;{/if}
            </td>    
         </tr>
         {/section}
  {include file="table_footer.tpl"}
    ...
    {include file="table_header.tpl"}
       ...
       {assign var="_i_" value=$smarty.section.est.index}
        <tr class="{if $_i_ is even}cell_reccolor_red_01a{else}cell_reccolor_red_01b{/if}">
         ...
         <td width="10%"><a href="ord_shapeedit.php?id_account={$id_account}&oid={$oid}&uid={$uid}&edd={$crshapes[est].id}"><img src="gfx/edit_one1.gif" 

onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit custom charge '{$crshapes[est].name}'" border="0"></a></td>
       </tr>
       {/section}
    {include file="table_footer.tpl"}
    <br>
 ...
 {if is_array($crcutouts) && count($crcutouts)>0}
  ...
  {include file="table_header.tpl"}
         ...
         <tr class="{if $_i_ is even}cell_reccolor_blue_01a{else}cell_reccolor_blue_01b{/if}">
          ...
          <td valign="middle"><a href="ord_cutoutedit.php?cutid={$crcutouts[ord].id}&id_account={$id_account}&oid={$oid}&uid={$uid}"><img src="gfx/edit_one1.gif" 

onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit cutout '{$crcutouts[ord].id}'" border="0"></a></td>
         </tr>
         {/section}
  {include file="table_footer.tpl"}
  <br>
  ...
  {include file="table_header.tpl"}
         ...
         <tr class="{if $_i_ is even}cell_reccolor_blue_01a{else}cell_reccolor_blue_01b{/if}">
          ...
          {if $cutt_edit}
           ...
           <img src="gfx/edit_one1.gif" onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit cutter '{$crcutters[ord].lname}'" 
 ...
 {if is_array($crunits) && count($crunits)>0}
  ...
  {include file="table_header.tpl"}
         ...
         <tr class="{if $_i_ is even}cell_reccolor_grey_01a{else}cell_reccolor_grey_01b{/if}">
           ...
           <td width="10%" valign="top"><a href="ord_unitedit.php?uid={$crunits[ord].id}&id_account={$id_account}&oid={$oid}"><img src="gfx/edit_one1.gif" 

onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit unit '{$crunits[ord].id}'" border="0"></a></td>
         </tr>
         {/section}
  {include file="table_footer.tpl"}
  <br>
 ...
 {if is_array($crtemplate) && count($crtemplate)>0}
  ...
  {include file="table_header.tpl"}
         ...
         <tr class="cell_reccolor_blue_01a">
           ...
           <td width="10%" valign="top"><a href="ord_templateedit.php?id={$crtemplate[0].id}&id_account={$id_account}&oid={$oid}&uid={$uid}"><img src="gfx/edit_one1.gif" 

onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit template '{$crtemplate[0].id}'" border="0"></a></td>
         </tr>
  {include file="table_footer.tpl"}
  <br>
 {/if}
 {if is_array($crinstall) && count($crinstall)>0}
  ...
  {include file="table_header.tpl"}
         ...
         <tr class="cell_reccolor_green_01a">
           ...
           <td width="10%" valign="top"><a href="ord_installationedit.php?id={$crinstall[0].id}&uid={$uid}&id_account={$id_account}&oid={$oid}"><img 

src="gfx/edit_one1.gif" onmouseover="this.src='gfx/edit_one0.gif'" onmouseout="this.src='gfx/edit_one1.gif'" alt="Edit installation '{$crinstall[0].id}'" 
  ...
  <tr><td align="left">
       ...
       <tr><td >
                <table><tr class="cell_reccolor_neutral_01">
                              <td width="20%"><a href="#" onClick="javascript:window.open('print_template.php?oid={$oid}&uid=

{$uid}','print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');">Template</a></td>
                              <td width="20%"><a href="#" onClick="javascript:window.open('print_install.php?oid={$oid}&uid={$uid}

&no_address=false','print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');">Installation</a></td>
                              <td width="20%"><a href="#" onClick="javascript:window.open('print_production.php?oid={$oid}&uid=

{$uid}','print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');">Production</a></td>
                              <td width="20%"><a href="#" onClick="javascript:window.open

('upload/form/Natural_Stone_Disclaimer.pdf','print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');">Natural Stone Disclaimer</a></td>
							  <td width="20%"><a href="#" onClick="javascript:window.open('upload/form/Drawing_Template

{$ord_unit.id_location}.pdf','print_order','toolbar=1,menu=1,scrollbars=1,resizable=1');">Drawing Template</a></td>
                </tr></table>
       </td></tr>
       {include file="table_footer.tpl"}
  </td></tr>
